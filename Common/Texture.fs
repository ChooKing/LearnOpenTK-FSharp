...
type Texture(glHandle: int) as this =
    //The original C# defines PixelFormat earlier in a using statement
    //let PixelFormat = OpenTK.Graphics.OpenGL4.PixelFormat
    [<DefaultValue>]
    ...
    static member LoadFromFile(path:string) =
        ...
        // Here you can see and read about the moiré effect https://en.wikipedia.org/wiki/Moir%C3%A9_pattern
    ...
    member this.Use(unit:TextureUnit) =
