...
type Window(gameWindowSettings, nativeWindowSettings) =
    ...
    override this.OnLoad() =
        ...
        // One notable thing about the buffer we just loaded data into is that it doesn't have any structure to it. It's just a bunch of floats (which are actually just bytes).
        ...
        // Now, we need to set up how the vertex shader will interpret the VBO data; you can send almost any C datatype (and a few non-C ones too) to it.
        ...
        // This means that after this call, we have set up this attribute to source data from the current array buffer and interpret it in the way we specified.
        // Arguments:
    ...
    override this.OnUnload() =
        ...
        GL.DeleteProgram this._shader.Handle
        base.OnUnload()